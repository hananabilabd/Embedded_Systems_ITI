...
//https://www.electronicwings.com/sensors-modules/nokia5110-graphical-display
...
void lcd_setPosition(char x, char y)		/* set the row and column */
{
	y+=0x80;
	x+=0x40;
	N5110_Cmnd(x);
