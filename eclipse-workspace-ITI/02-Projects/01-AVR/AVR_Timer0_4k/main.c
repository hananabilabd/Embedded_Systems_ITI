...
int main(void){
	...
	DIO_u8SetPinDirection(DIO_U8_PIN_C7,DIO_U8_OUTPUT);
	DIO_u8SetPinDirection(DIO_U8_PIN_C6,DIO_U8_OUTPUT);
	DIO_u8SetPinValue(DIO_U8_PIN_C6,1);
	//DIO_u8SetPortDirection(DIO_U8_PORT_C,0xFF);

	DIO_u8SetPinValue(DIO_U8_PIN_C7,DIO_U8_LOW);
	TCNT0=137;
	TIMSK |= 0x01;
	SREG |= 0x80;
	TCCR0 = 0b00000010;
