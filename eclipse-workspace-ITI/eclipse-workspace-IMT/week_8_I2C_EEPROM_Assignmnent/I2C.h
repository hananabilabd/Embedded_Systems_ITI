...
#define SLAVE_ADD_RCVD_RD_REQ    0xA8 // means that slave address is received with write req (slave_transmitter)
#define SLAVE_ADD_RCVD_WR_REQ    0x60 // means that slave address is received with read req (slave receiver)
